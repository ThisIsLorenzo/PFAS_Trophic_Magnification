---
title: "Analysis Code"
author: "Script created and curated by Lorenzo Ricolfi"
output:
  html_document:
    code_folding: hide
    toc: yes
...
The following code chunks modify the OrchaRd plot function to display model outputs on the natural log scale (ln_TMF) while plotting them on the original scale (TMF), improving the interpretability of results and refining plot aesthetics. The final chunk similarly adjusts the bubble_plot function for minor visual enhancements. Together, the code defines three modified functions: orchard_plot_new, orchard_plot_new2, and bubble_plot_new.
...
```{r, fig.cap="Note: Maximum TMF value set to 10"}
...
```{r, fig.cap="Note: Maximum TMF value set to 12"}
