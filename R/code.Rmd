...
Cara_2022_loc4$PFOA_mean <- as.numeric(as.character(Cara_2022_loc4$PFOA_mean))
Cara_2022_loc4$PFOA_sd <- as.numeric(as.character(Cara_2022_loc4$PFOA_sd))
Cara_2022_loc4$TL_mean <- as.numeric(as.character(Cara_2022_loc4$TL_mean))
...
Cara_2022_loc5$PFOA_mean <- as.numeric(as.character(Cara_2022_loc5$PFOA_mean))
Cara_2022_loc5$PFOA_sd <- as.numeric(as.character(Cara_2022_loc5$PFOA_sd))
Cara_2022_loc5$PFUnDA_mean <- as.numeric(as.character(Cara_2022_loc5$PFUnDA_mean))
Cara_2022_loc5$PFUnDA_sd <- as.numeric(as.character(Cara_2022_loc5$PFUnDA_sd))
Cara_2022_loc5$TL_mean <- as.numeric(as.character(Cara_2022_loc5$TL_mean))
...
Cara_2022_loc8$PFOA_mean <- as.numeric(as.character(Cara_2022_loc8$PFOA_mean))
Cara_2022_loc5$PFTrDA_mean <- as.numeric(as.character(Cara_2022_loc5$PFTrDA_mean))
Cara_2022_loc8$TL_mean <- as.numeric(as.character(Cara_2022_loc8$TL_mean))
...
Cara_2022_loc8_lm_model_PFOA <- lm(PFOA_mean ~ TL_mean, data = Cara_2022_loc8)
summary(Cara_2022_loc8_lm_model_PFOA)

Cara_2022_loc5_lm_model_PFTrDA <- lm(PFTrDA_mean ~ TL_mean, data = Cara_2022_loc8)
